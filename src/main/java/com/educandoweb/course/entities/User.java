...
@Entity // depender da especificaçao e nao da implementacao
@Table(name = "tb_user")
public class User implements Serializable { // transofmrar em cadeia de bytes para arquivos e tal
	...
	public List<Order> getOrders() {  // nao pode ter setter
		return orders;
	}
